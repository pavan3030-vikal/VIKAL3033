...
const RAZORPAY_LINK = "https://razorpay.com/payment-link/plink_Q0hzTfIX0l2sHx/test"; // Your test link
...
const DashboardPage: React.FC = () => {
  ...
  const handleUpgradeToPro = () => {
    window.location.href = RAZORPAY_LINK; // Redirect to Razorpay test link
  };
              ...
              <Button
                ...
                leftIcon={
                  <svg viewBox="0 0 24 24" width="24" height="24">
                    <path fill="#0a0a0c" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                    <path fill="#0a0a0c" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
                    <path fill="#0a0a0c" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
                    <path fill="#0a0a0c" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
                  </svg>
                }
                fontSize="lg"
                fontWeight="bold"
  ...
  return (
    ...
    >
      ...
      {termsAccepted && (
        <>
          <Box w={{ base: "full", md: "250px" }} p={padding} bg="rgba(20, 20, 25, 0.9)" backdropFilter="blur(12px)" borderRight="1px solid rgba(255, 255, 255, 0.1)" position={{ base: "relative", md: "fixed" }} top={0} h={{ base: "auto", md: "100vh" }} zIndex={2} display="flex" flexDirection="column">
            <Box flexShrink={0}>
              <HStack spacing={2} mb={1}>
                <Image src="/image27.png" alt="VIKAL Logo" boxSize="95px" />
              </HStack>
              <Text fontSize="xs" color="gray.400" mb={4}>AI Tyari VIKAL</Text>
            </Box>
            <VStack spacing={4} align="stretch" flex={1} overflowY="auto">
              ...
              >
                <HStack justify="space-between">
                  <Text fontSize="sm" color="#ffdd57">Summarize YouTube</Text>
                  <ChevronRightIcon color="#ffdd57" />
                </HStack>
              </MotionBox>
              <Text fontSize="sm" fontWeight="medium" color="gray.300">Recent 📜</Text>
              {chatHistory.map((chat) => (
                <MotionBox key={chat.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
                  <Box p={2} bg="rgba(40, 40, 45, 0.8)" borderRadius="md" _hover={{ bg: "rgba(60, 60, 65, 0.8)", transform: "translateY(-2px)" }} transition="all 0.2s" cursor="pointer" boxShadow="0 2px 8px rgba(0, 0, 0, 0.2)" onClick={() => { setSearchQuery(chat.question); setResponseData({ notes: chat.response, resources: [] }); }}>
                    <Text fontSize="xs" noOfLines={1}>{chat.question}</Text>
                    <Text fontSize="2xs" color="gray.500">{new Date(chat.timestamp).toLocaleTimeString()}</Text>
                  </Box>
                </MotionBox>
              ))}
            </VStack>
            <Box flexShrink={0} p={4} borderTop="1px solid rgba(255, 255, 255, 0.1)">
              <VStack spacing={2}>
                <HStack spacing={2}>
                  ...
                  <Text fontSize="xs" fontWeight="medium">{user.displayName}</Text>
                </HStack>
                <Button w="full" bg="#ffdd57" color="#0a0a0c" rounded="full" size="sm" _hover={{ transform: "scale(1.03)" }} onClick={handleSignOut}>Sign Out</Button>
              </VStack>
            </Box>
          </Box>
          ...
          <Box flex={1} ml={{ base: 0, md: "250px" }} p={padding} zIndex={1}>
            {showTrialEndPopup && (
              ...
              >
                <VStack spacing={4}>
                  <Text fontSize="2xl" fontWeight="bold" bgGradient="linear(to-r, #ffdd57, white)" bgClip="text" fontFamily="Orbitron, sans-serif">
                    Free Trial Ended!
                  </Text>
                  ...
                  <Box p={3} bg="rgba(40, 40, 45, 0.9)" borderRadius="md" border="2px solid #ffdd57">
                    <Text fontSize="lg" fontWeight="bold" color="#ffdd57">₹199/month</Text>
                    <Text fontSize="sm" color="gray.400">Unlimited chats & premium features</Text>
                  </Box>
            ...
            {isProModalOpen && !showTrialEndPopup && (
              ...
              >
                <VStack spacing={4}>
                  <Text fontSize="2xl" fontWeight="extrabold" bgGradient="linear(to-r, white, #ffdd57)" bgClip="text" fontFamily="Orbitron, sans-serif">
                  ...
                  <Box p={4} bg="rgba(40, 40, 45, 0.8)" borderRadius="md" border="1px dashed #ffdd57">
                    <Text fontSize="xl" fontWeight="bold" color="#ffdd57">₹199/month</Text>
                    <Text fontSize="sm" color="gray.300">
                      - Unlimited AI chats<br />
                      - Custom exam dates (soon)<br />
                      - Priority support
                    </Text>
                  </Box>
                  ...
                  <FormControl>
                    <FormLabel fontSize="sm" color="gray.300">How’s your experience with VIKAL?</FormLabel>
                    <Textarea
                      value={feedback}
            ...
            <VStack align="stretch" maxW="4xl" mx="auto" spacing={6}>
              <MotionBox initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.6 }}>
                <HStack justify="center" spacing={0}>
                  ...
                  <Text fontSize="75px" color="#ffdd57" fontFamily="Orbitron,sans-serif">VIKAL</Text>
                </HStack>
                ...
                <Text fontSize="sm" color="gray.400" textAlign="center">AI Tyari VIKAL - Ace Exams & Learn Smart</Text>
              ...
              <VStack w="full" spacing={2} mb={6}>
                <HStack justify="center" spacing={4}>
                  <HStack>
                    ...
                    <Text fontSize="sm" color={isSolveMode ? "gray.500" : "#ffdd57"}>Learn</Text>
                  </HStack>
                  <Switch
                  ...
                  />
                  <HStack>
                    <Text fontSize="sm" color={isSolveMode ? "#ffdd57" : "gray.500"}>Solve</Text>
                ...
                <HStack w="full" spacing={4}>
                  <Box position="relative" w="full">
                    <Input
                      placeholder={isSolveMode ? "Enter your problem (e.g., Solve 2x + 3 = 7)" : "Type your topic (e.g., How does the internet work?)"}
                      value={searchQuery}
                  ...
                  {isSolveMode && (
                    <Menu>
                      <MenuButton as={Button} w="200px" bg="rgba(50, 50, 55, 0.8)" color="white" rightIcon={<ChevronDownIcon />} _hover={{ bg: "rgba(70, 70, 75, 0.8)" }} borderRadius="md" size="md">
                        {selectedExam}
                      </MenuButton>
                      <MenuList bg="rgba(40, 40, 45, 0.9)" border="none" borderRadius="md" minW="120px">
                        {exams.map((exam) => (
                          <MenuItem key={exam} onClick={() => setSelectedExam(exam)} bg="transparent" _hover={{ bg: "rgba(60, 60, 65, 0.8)" }} fontSize="sm">{exam}</MenuItem>
                        ))}
                      </MenuList>
                    </Menu>
                  )}
                  ...
                  <Menu>
                    ...
                    <MenuList bg="rgba(40, 40, 45, 0.9)" border="none" borderRadius="md" minW="120px">
                      {examStyles.map((style) => (
                        <MenuItem key={style} onClick={() => setSelectedStyle(style)} bg="transparent" _hover={{ bg: "rgba(60, 60, 65, 0.8)" }} fontSize="sm">{style}</MenuItem>
                      ))}
                    </MenuList>
                  </Menu>
                )}
                ...
                <HStack justify="space-around" spacing={4}>
                  <VStack>
                    <MotionBox
                      ...
                      transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                    >
                      <Text fontSize="2xl" fontWeight="extrabold" color="#ffdd57">{stats.active_users}</Text>
                    </MotionBox>
                  ...
                  <VStack>
                    ...
                    >
                      <Text fontSize="2xl" fontWeight="extrabold" color="#ffdd57">{stats.questions_solved}</Text>
                    </MotionBox>
                    <Text fontSize="sm" color="gray.400">Questions Solved</Text>
                  </VStack>
                  <VStack>
                    <MotionBox
                      animate={{ scale: [1, 1.1, 1] }}
                    ...
                    >
                      <Text fontSize="2xl" fontWeight="extrabold" color="#ffdd57">{stats.explanations_given}</Text>
                    </MotionBox>
                    <Text fontSize="sm" color="gray.400">Explanations Given</Text>
                  </VStack>
                </HStack>
              </MotionBox>
                ...
                <VStack spacing={6} align="stretch">
                  ...
                  >
                    <HStack justify="space-between" mb={4}>
                      ...
                      <Tooltip label={hasCopied ? "Copied!" : "Copy"} placement="top">
                        <IconButton icon={hasCopied ? <CheckIcon /> : <CopyIcon />} onClick={onCopy} aria-label="Copy" size="sm" variant="ghost" color="#0a0a0c" _hover={{ bg: "rgba(0, 0, 0, 0.1)" }} />
                      </Tooltip>
                    </HStack>
                  ...
                  {responseData.flashcards && responseData.flashcards.length > 0 && !isSolveMode && (
                    <MotionBox
                      ...
                      border="1px solid rgba(255, 221, 87, 0.2)"
                    >
                      <Text fontSize="lg" fontWeight="bold" bgGradient="linear(to-r, white, #ffdd57)" bgClip="text" mb={4}>Flashcards 📚</Text>
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <Text fontSize="sm" color="white" textAlign="center" fontWeight="bold">Q: {question}</Text>
                                </Box>
                                <Box
                                  position="absolute"
                                  w="100%"
                                ...
                                >
                                  <Text fontSize="sm" color="white" textAlign="center">A: {answer}</Text>
                                </Box>
                              </Box>
                            </MotionBox>
                          );
                  ...
                  <MotionBox
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: (responseData.examTips && responseData.flashcards && !isSolveMode) ? 0.6 : (responseData.examTips || responseData.flashcards && !isSolveMode) ? 0.4 : 0.2 }}
                    bg="rgba(30, 30, 35, 0.9)"
                    backdropFilter="blur(12px)"
                    p={6}
                    borderRadius="xl"
                    ...
                    border="1px solid rgba(255, 221, 87, 0.2)"
                  >
                    <Text fontSize="lg" fontWeight="bold" bgGradient="linear(to-r, white, #ffdd57)" bgClip="text" mb={4}>Resource Hub 📖</Text>
                    <VStack align="start" spacing={2} maxH="200px" overflowY="auto">
                      {responseData.resources.length > 0 ? (
                        responseData.resources.map((res, idx) => (
                          <Link key={idx} href={res.url} isExternal color="gray.300" fontSize="sm" _hover={{ color: "#ffdd57", textDecoration: "underline" }}>
                            {res.title} <ExternalLinkIcon mx="2px" />
                          </Link>
                        ))
                      ) : (
                        <Text fontSize="sm" color="gray.500">No resources available.</Text>
                      )}
                    </VStack>
                  </MotionBox>
                </VStack>
